        ...
        <main id="home"class="main">
                ...
                <div class="container">
                    ...
                    <div class="main-works-item">
                        ...
                        <div class="main-works-item-text">
                            ...
                            <p>この文章はダミーです。文字の大きさ、量、字間、行間等を確認するために入れています。この文章はダミーです。文字の大きさ、量、字間、行間等を確認するために入れています。この文章はダミーです。文字の大きさ、量、字間、行間等を確認するために入れています。</p>
                            <p>この文章はダミーです。文字の大きさ、量、字間、行間等を確認するために入れています。この文章はダミーです。文字の大きさ、量、字間、行間等を確認するために入れています。この文章はダミーです。文字の大きさ、量、字間、行間等を確認するために入れています。</p>
                            <a href="project.html" class="button-secondary"></a>
                        </div>
                    </div>
                </div>
            </section>
            <section id="about" class="main-about">
                ...
                <figure class="main-about-img">
                    <img src="images/images-profile.jpg" alt="profile" class="mobile">
                    <img src="images/image-about.jpg" alt="about" class="table-and-up">
                </figure>
                <div class="container">
